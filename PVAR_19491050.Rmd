...
Furthermore, the authors do not explicitly provide diagnostic tests such as autocorrelation functions (ACFs) or Q-stats, important tools with which to check for white noise errors. Similarly, structural breaks are not estimated

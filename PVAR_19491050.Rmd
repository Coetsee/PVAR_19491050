...
Like the authors, we employ four tests for unit roots^[the Fischer-type ADF, LLC, HT and IPS tests], and one explicitly for stationarity^[The Hadri LM test]. Like @atems, these tests are performed on demeaned data. 

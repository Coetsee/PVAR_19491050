...
shock in the level of the series.\footnote{All computation of OIRFs were
  done using a statistical package in R, `\emph{panelvar}', developed
  recently by Sigmund \& Ferstl
